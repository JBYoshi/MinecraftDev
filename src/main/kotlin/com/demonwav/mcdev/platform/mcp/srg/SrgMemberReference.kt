...
internal object SrgMemberReference {

    internal fun toString(reference: MemberReference): String {
        return reference.owner!!.replace('.', '/') + '/' + reference.name + (reference.descriptor ?: "")
    }

    internal fun parse(reference: String, descriptor: String? = null): MemberReference {
